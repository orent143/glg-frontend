        ...
        <div className="flex-shrink-0 w-56 group">
            <div className="bg-white rounded-2xl border border-slate-100 overflow-hidden shadow-md hover:shadow-2xl transition-all duration-500 h-full flex flex-col hover:border-red-100">
                ...
                <div className="relative h-56 bg-gradient-to-br from-slate-50 to-slate-100 overflow-hidden flex items-center justify-center">
                    ...
                    {/* Badge */}
                    {product.badge && (
                        <div className="absolute top-4 left-4 bg-red-600 text-white px-3 py-1.5 rounded-full text-xs font-bold tracking-widest shadow-lg transform group-hover:scale-110 transition-transform duration-300">
                            {product.badge}
                        </div>
                    )}
                    {/* Wishlist Icon */}
...
export default function FeaturedProducts() {
    ...
    return (
        <section className="relative isolate w-full h-screen overflow-hidden bg-slate-100">
            ...
            {/* Content */}
            <div className="relative z-10 flex items-center justify-center h-full px-6 md:px-30">
                    ...
                    <div className="max-w-lg flex flex-col items-start gap-6">
                        ...
                        <div>
                            ...
                            <p className="text-white text-[20px] font-regular">
                                Discover our most popular medicines and everyday health essentials.                            </p>
                        </div>
                        {/* Portrait Image Placeholder */}
                        <div className="w-56 h-80 bg-slate-200 rounded-xl overflow-hidden flex items-center justify-center">
